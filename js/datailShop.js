...
$(function(){
    ...
    $(".lookImg").on({
        'mouseover':function(){
            $(this).children(".hideIm").css("visibility","visible");
        },
        'mouseout':function(){
            $(this).children(".hideIm").css("visibility","hidden");
        }
    })
    ...
    $(".add-to-cart").on('click',function(){
        var img=$('.jqzoom').find('img')[0].src;
        var fly = $('<div class="flyer"><img src='+img+' class="responsive-img"/></div>');
        var x=$("#preview").offset().left;
        var y=$("#preview").offset().top;
        var lastX=$(".tab-logo_cart").offset().left;
        var lastY=$(".tab-logo_cart").offset().top;
        $('body').append(fly);
